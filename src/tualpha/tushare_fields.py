"""Explicit Tushare financial field lists requested by the updater."""
...
FINANCIAL_FIELDS: dict[str, tuple[str, ...]] = {
    "balancesheet": _fields(
        ...
        fair_value_fin_assets cip_total oth_pay_total long_pay_total debt_invest
        oth_debt_invest oth_eq_invest oth_illiq_fin_assets oth_eq_ppbond
        receiv_financing use_right_assets lease_liab contract_assets contract_liab
